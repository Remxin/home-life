...
import { validateEmail, validatePassword, validateUsername } from '@/validations/val'
  ...
  return (
      <PageView>
          ...
          <View style={styles.loginForm}>
            ...
            <Image style={styles.penguinImage} source={require("@/assets/images/penguin.png")}/>
            <Form values={["email", "password"]} submit={onSubmit}>
              <Input name="email" inputStyle={styles.input} placeholder='Email' validationFunction={validateEmail}/>
              <Input name="name" inputStyle={styles.input} placeholder='Name' validationFunction={validateUsername}/>
              <Input name="password" secure={true} inputStyle={styles.input} placeholder='Password' validationFunction={validatePassword}/>
